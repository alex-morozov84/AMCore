...
// `closeLabel` mirrors `DialogContent`'s discriminated union (see dialog.tsx)
// — `shared/ui` owns no message-catalogue keys, so the caller must supply
// translated text rather than a literal baked in here. See
