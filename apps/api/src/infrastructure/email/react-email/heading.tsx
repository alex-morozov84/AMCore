...
import { markAsElement } from './element-marker'
...
export const Heading = React.forwardRef<HTMLHeadingElement, Readonly<HeadingProps>>(
  ({ as: Tag = 'h1', children, style, m, mx, my, mt, mr, mb, ml, ...props }, ref) => {
    return (
      <Tag {...props} ref={ref} style={{ ...withMargin({ m, mx, my, mt, mr, mb, ml }), ...style }}>
        {children}
      </Tag>
    )
  }
