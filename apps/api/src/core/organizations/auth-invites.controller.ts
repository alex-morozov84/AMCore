...
export class AuthInvitesController {
  ...
  @ApiOperation({
    summary:
      'Accept a pending invite using the token from the invite email. ' +
      'The authenticated user must own the canonical email the invite ' +
      'was issued for and must have a verified email address. On success ' +
