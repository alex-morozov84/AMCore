...
readiness, **Users** inventory and system-role changes, read-only
...
safe extension recipe are included. It is not a product backoffice or a
...
| **Operations Console**   | ✅ Shipped      | Optional `SUPER_ADMIN` control plane with Overview, user and organization detail pages, Users role changes, Audit browsing, path/host sessions and scaffolding                              |
...
| Operations Console                  | [`docs/operations-console/`](docs/operations-console/README.md) — using Overview, user and organization details, Users role management and Audit browsing; topology, session security, scaffolding, deployment, verification, and extension contract                                                                                                                                                                                                                                                                                                             |
