...
| **Browser security** | ✅ Shipped      | `apps/web` security-header baseline, nonce-based Content Security Policy (enforced in production by default) with a minimal violation-reporting endpoint                                                                                                             |
