...
| **Operations Console**   | ✅ Shipped      | Optional `SUPER_ADMIN` control plane with Overview, Users role changes, read-only Organizations, Audit browsing, path/host sessions and scaffolding                                         |
...
| Operations Console                  | [`docs/operations-console/`](docs/operations-console/README.md) — using Overview, Users role management, read-only Organizations and Audit browsing; topology, session security, scaffolding, deployment, verification, and extension contract                                                                                                                                                                                                                                                                                                                   |
