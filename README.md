...
- [`docs/ai/`](docs/ai/README.md) — AI capability layer guide (provider-agnostic catalog, `ModelGateway`, durable runs + run API + status-only SSE, usage ledger, persistence + contracts; guardrails/tools/takeover/multimodal arcs in progress)
