// Text fixture for project-plan-web-nav-route-progress-bar-stories.mjs --
// the current (pre-transform) content of route-progress-bar.stories.tsx.
// Split out to stay under the repo's ~150-line-per-file guidance.
export const ROUTE_PROGRESS_BAR_STORIES_BEFORE = `import type { Meta, StoryObj } from '@storybook/nextjs-vite'
