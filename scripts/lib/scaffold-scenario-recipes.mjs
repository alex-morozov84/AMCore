...
export const SCAFFOLD_EXHAUSTIVE_SCENARIOS = [
...
// Kept as a compatibility alias for archived PR1 measurement consumers.
export const SCAFFOLD_MEASUREMENT_SCENARIOS = SCAFFOLD_EXHAUSTIVE_SCENARIOS
