...
const CAPABILITIES_A11Y_ROW_BEFORE =
...
const CAPABILITIES_A11Y_ROW_AFTER =
  `| **Accessibility (a11y)** | ✅ Shipped      | WCAG AA contrast enforced by a dependency-free test on the shipped token CSS, \`@axe-core/playwright\` WCAG A/AA scans on real pages                                                          |
`

const CAPABILITIES_WORKSHOP_ROW =
