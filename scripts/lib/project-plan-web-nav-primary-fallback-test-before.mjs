// Text fixture for project-plan-web-nav-primary-fallback-test.mjs -- the
// current (pre-transform) content of
// primary-unavailable-fallback.test.tsx. Split out to stay under the
// repo's ~150-line-per-file guidance.
export const PRIMARY_FALLBACK_TEST_BEFORE = `import { NextIntlClientProvider } from 'next-intl'
