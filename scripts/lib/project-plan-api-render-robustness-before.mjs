// The "before" half of project-plan-api-render-robustness-test.mjs's
// exactContentStep, split into its own file to stay under the repo's
// ~150-line-per-file guidance — the combined before/after pair for this
// fixture is long even by this session's own disclosed-exception standard.
export const RENDER_ROBUSTNESS_BEFORE = `/**
