// AMCore observability contract — generic Markdown extraction: fenced code
// blocks (incl. tagged PromQL), relative links, and headings (for anchor
// slugs). The structured dashboard-panel citation idiom lives in
// panel-citations.mjs, split out to keep both files under the repo's
// <150-line limit.
