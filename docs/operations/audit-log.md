...
are served. The read event may appear on a later refresh of the panel.
...
configuration](../operations-console/configuration.md#search-terms-in-logs-and-browser-history).
