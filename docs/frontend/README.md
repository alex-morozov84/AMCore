...
| [Operations Console](../operations-console/README.md)                   | The isolated `SUPER_ADMIN` control plane: Overview, Users role management, read-only Organizations, Audit browsing, FSD ownership, topology, session boundary, deployment, verification, and extension rules                                                                                                                           |
